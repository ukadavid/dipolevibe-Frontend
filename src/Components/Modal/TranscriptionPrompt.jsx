...
function TranscriptionPrompt(props) {
  const { displayModal,handleTranscriptionSubmit } = props;
                ...
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-green-100 sm:mx-0 sm:h-10 sm:w-10">
                      <TbFileDescription className="h-6 w-6 text-green-400" aria-hidden="true" />
                    </div>
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Submitting this video will make a transcription of the audio
                        </p>
                      </div>
                    </div>
                  </div>
...
export default TranscriptionPrompt;