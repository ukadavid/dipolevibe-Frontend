...
import { FaHome, FaFolder, FaBell, FaClock, FaUser, FaCog, FaChartBar } from "react-icons/fa";
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/" className="block">
            <span className='text-right font-medium text-sm text-white py-1 px-3 w-8 h-8 flex items-center justify-center bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600/80 rounded-full'>Dip  <span className='text-black'>olev</span>ibe</span>
          </NavLink>
        </div>
