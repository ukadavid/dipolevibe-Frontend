...
const SocialMediaShare = ({ url }) => {
  ...
  const iconStyle =
    "flex bg-sky-400 text-white	border border-black	rounded-2xl w-8 h-8 justify-center";
  ...
  return (
    <div className="social-media-share ">
      ...
      <ul
        className={`list-social transition-opacity ${
          socialOpened ? "opacity-100" : "opacity-0"
        } duration-500`}
      >
