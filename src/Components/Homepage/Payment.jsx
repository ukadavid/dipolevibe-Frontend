    ...
    <main className=" bg-gray-800 py-8 dark:bg-gray-800">
      <div className="text-center ">
        ...
        <p className="text-sm font-normal text-gray-400">
          Explore our three primary plans tailored for individuals, businesses,
          startups, and agencies.
        </p>
        <p className="text-sm font-normal text-gray-400">
          Embark on a journey of self-improvement and discover what truly
          resonates with you. Record, transcribe, and engage with your content
          effortlessly.
        </p>
      </div>
      ...
      <div className="flex items-center justify-center mt-10 space-x-4">
        ...
        >
          ...
          <div
            ...
            style={{
              transform: `translateX(${billPlan === "monthly" ? "0" : "33"}px)`,
            }}
          ></div>
        </button>
        ...
        {plans.map((plan, i) => (
          ...
          >
            <div className="flex-shrink-0">
              <span
                className={`text-4xl font-medium dark:text-gray-800 tracking-tight ${
            ...
            <div className="flex-shrink-0 pb-6 space-y-2 border-b">
              <h2 className="text-2xl dark:text-gray-800 font-normal">
                {plan.name}
              </h2>
            ...
            <ul className="flex-1 space-y-4">
              {plan.features.map((feature, i) => (
                <li key={i} className="flex items-start">
                  ...
                  <span className="ml-3 text-base dark:text-gray-800 font-medium">
                    {feature}
                  </span>
                </li>
              ))}
              ...
              <button
                className={`inline-flex items-center justify-center w-full max-w-xs px-4 py-2 transition-colors border rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                  plan.name === "Basic"
                    ...
                    : "dark:bg-white dark:text-gray-800 dark:hover:text-white dark:hover:bg-indigo-500 hover:bg-indigo-500 hover:text-white"
                }`}
              >
                {`Get ${plan.name}`}
              </button>
