...
const TestimonialCarousel = () => {
  return (
    <section>
        ...
        <h2 className="pt-8 text-center text-black text-3xl font-bold">Testimonials</h2>
            ...
            <figure className="mt-10">
              ...
              <figcaption className="mt-10">
                <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                  <div className="font-semibold text-black">Michael Chen
</div>
                  <svg
                    viewBox="0 0 2 2"
                    width="3"
                  ...
                  <div className="text-black">Team Lead</div>
                </div>
              </figcaption>
            </figure>
          </div>
        ...
        <div className="relative isolate overflow-hidden  px-6 py-8 sm:py-32 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl lg:max-w-4xl">
            ...
            <figure className="mt-10">
              ...
              <figcaption className="mt-10">
                <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                  <div className="font-semibold text-black">Jennifer Lee</div>
                  <svg
                    viewBox="0 0 2 2"
                    width="3"
                    height="3"
                  ...
                  <div className="text-black">Project Manager</div>
                </div>
              </figcaption>
            </figure>
          </div>
